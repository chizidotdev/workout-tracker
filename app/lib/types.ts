...
export enum WorkoutsStatusOptions {
  "pending" = "pending",
  "completed" = "completed",
}
...
export type ProgressMetricsResponse<Texpand = unknown> = Required<ProgressMetricsRecord> &
  BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>;
export type WorkoutExercisesResponse<Tsets = unknown, Texpand = unknown> = Required<
  WorkoutExercisesRecord<Tsets>
> &
  BaseSystemFields<Texpand>;
export type WorkoutsResponse<Texpand = unknown> = Required<WorkoutsRecord> &
  BaseSystemFields<Texpand>;
